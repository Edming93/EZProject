...
<div id="contain">
    <div>
        <ul id="submenu">
            <a class="menu" href="${pageContext.request.contextPath}/admin/subselect?subselect=¼Ò¼È¸ÅÄ¡"><li>¼Ò¼È¸ÅÄ¡ ½ÅÃ» ÇöÈ²</li></a>
            <a class="menu" href="${pageContext.request.contextPath}/admin/subselect?subselect=ÆÀ¸ÅÄ¡"><li>ÆÀ¸ÅÄ¡ ½ÅÃ» ÇöÈ²</li></a>
        </ul>
    </div>
    <div id="maincontent">
        <%
