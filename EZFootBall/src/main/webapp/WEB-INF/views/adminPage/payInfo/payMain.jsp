...
<div id="contain">
    <div>
        <ul id="submenu">
            <a class="menu menu1" href="${pageContext.request.contextPath}/admin/payselect?payselect=pay"><li>搬力郴开</li></a>
            <a class="menu menu2" href="${pageContext.request.contextPath}/admin/payselect?payselect=cancel"><li>秒家郴开</li></a>            
        </ul>
    </div>
    <div id="maincontent">
        <%
