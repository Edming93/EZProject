		...
		if(document.getElementById("select").value == "gameCode"){
			...
			for(let i=0; i< document.getElementsByClassName("crlistnum").length; i++) {
				document.getElementsByClassName("crlistnum")[i].addEventListener("click",function(){
					console.log("diiididiidid");
					console.log(document.getElementsByClassName("crgamelist").lenght);
					for(let i=0; i<(<%=gamelist.size()%>); i++){
						document.getElementById("tbody").children[i].style.display = "none";
					}
					
					if (document.getElementsByClassName("crgamelist").length <15){
						listselect = 0;
				        for(let j= listselect; j<document.getElementsByClassName("crgamelist").length; j++){
							document.getElementsByClassName("crgamelist")[j].style.display = "";
						}
					}else if (this.innerText > (end-8)){
						listselect = end-15;
				        for(let j=0; j< document.getElementsByClassName("crgamelist").length; j++){
				        	document.getElementsByClassName("crgamelist")[j].style.display = "none";
				        }
				        for(let j= listselect; j<listselect+15; j++){
							document.getElementsByClassName("crgamelist")[j].style.display = "";
						}
					...
					if(sele-1 == 0) {
						if(document.getElementsByClassName("crgamelist").lenght <=15){
							for(let i=0; i<document.getElementsByClassName("crgamelist").lenght; i++){
					...
					}else if((num+15)>document.getElementsByClassName("crgamelist").lenght){
						for(let i=num; i<document.getElementsByClassName("crgamelist").lenght; i++){
							document.getElementsByClassName("crgamelist")[i].style.display = "";
						}
					}else{
						for(let i=num; i<num+15; i++){
